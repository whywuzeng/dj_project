...
jsObject.Setted = {
    ...
    InitTable: function () {
        ...
        $('#table1').bootstrapTable({
            ...
            url: '../Hrm/GetHr_PcMaker_ghys',        //后台数据url
    ...
    Export: function () {
        ...
        if (dataJson.length > 0) {
            ...
            window.open("../Hrm/ExportHr_PcMaker_ghys?startDate=" + _startDate + "&endDate=" + _endDate);
        }
        else {
            $('#result').html("当前无数据导出！");
            $("#myModal").modal("show");
